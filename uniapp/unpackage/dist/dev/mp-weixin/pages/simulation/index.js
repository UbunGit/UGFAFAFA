...
var _checker = __webpack_require__(/*! @/utils/checker.js */ 70);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
var _self;var canvaCandle = null;var _default = { data: function data() {return { cWidth: '', cHeight: '', pixelRatio: 1, itemCount: 20, //x轴单屏数据密度
      sliderMax: 50, textarea: '' };}, onLoad: function onLoad() {_self = this;this.cWidth = uni.upx2px(750);this.cHeight = uni.upx2px(500);this.getServerData();}, methods: { getServerData: function getServerData() {uni.request({ url: this.baseUrl + '/share/simulation', data: { "code": "300022.sz" }, success: function success(res) {console.log(res.data.data);var Candle = { categories: [], series: [] };
    ...
    showCandle: function showCandle(canvasId, chartData) {
      canvaCandle = new _uCharts.default({
        ...
        yAxis: {
          ...
          gridType: 'dash',
          splitNumber: 5,
          format: function format(val) {return val.toFixed(2);} },
