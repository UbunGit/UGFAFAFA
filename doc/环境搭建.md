...
```
pip3 install tushare pandas requests bs4  mysqlclient lxml Anaconda Flask sqlacodegen -i http://mirrors.aliyun.com/pypi/simple/   --trusted-host mirrors.aliyun.com
