...
```
pip3 install tushare pandas requests bs4 flask_sqlalchemy,sqlalchemy mysqlclient lxml Anaconda Flask -i http://mirrors.aliyun.com/pypi/simple/   --trusted-host mirrors.aliyun.com
