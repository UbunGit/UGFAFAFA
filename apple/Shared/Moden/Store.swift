...
//        if shareId!=nil {
//            setarr.append(Expression<Int64>("share_id") <- Int64(shareId!))
//        }
//        if Float64(price)>0 {
...
extension Store{
    static let _stores = [
        Store.init( id:0, share_id: 0, price: 4.00, num: 12300, day: "2020.10.12",state: 0, outprice: 5.00,outday: "2020.10.13"),
        Store.init( id:1,share_id:0, price: 5.00, num: 11300, day: "2020.10.12",state: 1, outprice: 5.00,outday: "2020.10.13"),
